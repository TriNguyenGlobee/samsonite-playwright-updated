...
export class BagsPageAU extends BagsPage {
    ...
    async assertBagsListItems(page: Page): Promise<void> {
        ...
        // --- bag-smart-function ---
        const { smartFunctionItemsB } = this.testData;

        await this.assertItemsListForCategoryMenu(this.baseLocator, 'bag-attribute', smartFunctionItemsB, { twoLinksPerLi: false });
